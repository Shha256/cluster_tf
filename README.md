...
| <a name="requirement_kubernets"></a> [kubernets](#requirement\_kubernets) | 2.17.0 |
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_eks_aws_load_balanacer_controller"></a> [eks\_aws\_load\_balanacer\_controller](#module\_eks\_aws\_load\_balanacer\_controller) | ./modules/aws-load-balancer-controle | n/a |
...
| <a name="input_project_name"></a> [project\_name](#input\_project\_name) | Project Name to be used to name the resources(Nametag) | `string` | n/a | yes |
